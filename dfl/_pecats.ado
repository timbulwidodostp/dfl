*! version 1.6.6 3/4/00 - bug fix    (STB-58: sg155)
*! version 1.6.5 2/16/00 - add regress; return 2 for count models
*! version 1.6.4 2/15/00 - only check model if no varlist specified
*!               - numcats = 2 if tobit, cnreg, intreg
*!               - added poisson, nbreg, zip, zinb, cloglog
*! version 1.6.3 - jf added clogit
*! version 1.6.2 - sl with logistic
*! version 1.6.1 - jf
    *bug fix in changing blanks to _s in labels
    *added catnms8 to handle long label names
    *added number of categories--r(numcats)
    *added refnm - name of reference category
    *only give refnm and refval after mlogit
*! version 1.6.0 2/14/1999 - jsl: _catnm to V6
